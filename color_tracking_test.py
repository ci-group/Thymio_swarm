...
CONFIG_PATH = os.path.join(CURRENT_FILE_PATH, 'configServer.json')
# show_map = True


class Tracker:
    def __init__(self, log_on_screen, show_map):
        ...
        # save log
        self.__experiment_name = "temp_name"
        ...
        try:
            ...
            pass
        self.__redOutput = os.path.join(output_path, self.__experiment_name + '_red.txt')
        self.__yellowOutput = os.path.join(output_path, self.__experiment_name + '_yellow.txt')
        self.__greenOutput = os.path.join(output_path, self.__experiment_name + '_green.txt')
        self.__simulationLogFile = os.path.join(output_path, self.__experiment_name + '_sim_debug.log')
...
#                outputFile.write(datetime.datetime.now().isoformat() + " \t " + str(evaluation) + " \t " + str(self.x_yellow) + " \t " + str(self.y_yellow))
#                outputFile.write("\n")
#            
#            # Write green output
#            with open(self.__greenOutput, 'a') as outputFile:
#                outputFile.write(datetime.datetime.now().isoformat() + " \t " + str(evaluation) + " \t " + str(self.x_green) + " \t " + str(self.y_green))
#                outputFile.write("\n")
#            
#            # Write red output
#            with open(self.__redOutput, 'a') as outputFile:
#                for i in range(0, len(self.red)):
#                    outputFile.write(datetime.datetime.now().isoformat() + " \t " + str(evaluation) + " \t " + str(i) + " \t " + str(self.red[i][0]) + " \t " + str(self.red[i][1]))
#                    outputFile.write("\n")
    ...
    def stop(self):
        if self.__stopped:
            logging.info('Simulation already stopped.')
            return
        self.__stopped = True
...
#        red_lower = np.array([120, 80, 80], np.uint8)
